...
public class TestCal {
    ...
    public void square_root_true_positive()
    {
        ...
        assertEquals("Square root function is not working properly",5,calculator.squareRoot(25),DELTA);
        assertEquals("Square root function is not working properly",1,calculator.squareRoot(1),DELTA);
        assertEquals("Square root function is not working properly",0,calculator.squareRoot(0),DELTA);
    }
    ...
    public void square_root_false_positive()
    {
        ...
        assertNotEquals("Square root function working properly",2,calculator.squareRoot(25),DELTA);
        assertNotEquals("Square root function working properly",0,calculator.squareRoot(1),DELTA);
        assertNotEquals("Square root function working properly",5,calculator.squareRoot(0),DELTA);
    }
    ...
    public void natural_log_true_positives()
    {
        ...
        assertEquals("Natural logarithm function is not working properly",0,calculator.naturalLog(1),DELTA);
    }
    ...
    public void natural_log_false_positives()
    {
        ...
        assertNotEquals("Natural logarithm function is working properly",6,calculator.naturalLog(15),DELTA);
        assertNotEquals("Natural logarithm function is working properly",9,calculator.naturalLog(29),DELTA);
        assertNotEquals("Natural logarithm function is working properly",1,calculator.naturalLog(1),DELTA);
    }
